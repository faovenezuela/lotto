...
function nuevoDato()
{
	...
	else
	{
		...
		var ajax=nuevoAjax();
		ajax.open("POST", "buscar_animal.php", true);
...

{
	...
	document.forms[0].buscar.value = valor;
...

{
	...
	//alert(arregloDeCadenas[0]);
	document.getElementById('input_2').value = arregloDeCadenas[0];
